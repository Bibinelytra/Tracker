...
<div class="container">
  <div class="row" style="background:white;box-shadow: 0px 0px 15px rgb(0 0 0 / 8%); margin-top:8rem; ">
   <form method="post" action="<?php echo base_url('Projects/editIssue/'.$id); ?>">
...
$issues = $this->db->where('iss_id',$id)->get('issues')->row(); ?>
        ...
        <label>Tracker:</label>   
         ...
         <?php $tracker = $issues->iss_tracker; ?>
        ...
        <textarea name="description" class="form-control"><?php echo $issues->iss_description; ?></textarea>
       </div>
