  ...
  <div class="row">
            ...
            <?php $status = $value->status; ?>             
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                      <p><?php  $desc = $value->iss_description;  
                    $out = strlen($desc) > 20 ? substr($desc,0,20)."..." : $desc;
                    echo $out;
 ?></p>
                                   ...
                                   <?php if($status == '1') { ?>
                                      ...
                                      <a class="btn btn-info" href="<?php echo base_url('edit-issue/'.$value->iss_id); ?>" style="float: right;margin-right: 12px;">Edit</a>
